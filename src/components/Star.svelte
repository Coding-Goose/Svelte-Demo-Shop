...
{#if visible}
    <div in:fly="{{delay: delay, duration: 300, x: 100, y: 100, opacity: 0.5, easing: quintOut}}">
        <svg fill="#61B68C" xmlns="http://www.w3.org/2000/svg"
             xmlns:xlink="http://www.w3.org/1999/xlink"
             version="1.1" viewBox="0 0 329.942 329.942" xml:space="preserve">
        <path
